// The `common.X` -> `@nestjs/common` shorthand table, covering every official @nestjs/* package.
...
// Inverse of the above, for display only — powers the package index's "nest-doc common.<name>" hint.
